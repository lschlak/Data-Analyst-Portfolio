        ...
        with ui.accordion_panel("Troubleshooting"):  
                ...
                def _():
                    m = ui.modal(
                        ...
                        ui.p("Error: You are trying to merge on datetime64[ns] and int64 columns. If you wish to proceed you should use pd.concat"),
                        ui.p("Solution: Ajust the time aggregation selection to an appropriate level of detail"),
                        ui.p(""),
                        ui.p("Error: To aggregate by 'tract', the DataFrame must have the 'tract' column."),
                        ui.p("Adjust the geographic aggregation selection to an appropriate level of detail. Tract is too low a level of detail based on the data provided (note: this could occur with any level of geographic that is more granular than the uploaded datasets)"),
                        ui.p(""),
                        ui.p("Error: 'GEO_ID' "),
                        ui.p("Adjust the geographic aggregate var"),
                        ui.p(""),
